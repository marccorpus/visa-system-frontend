<template>
  <div id="clients-visa-transaction-logs">
...
export default {
  ...
  methods: {
    ...
    getLogs() {
      ...
      clientTransactionLogs({ page: this.page }, this.$route.params.id)
        .then(response => {
...
<style lang="scss">
#clients-visa-transaction-logs .el-card__header {
  padding: 10px;
}
#clients-visa-transaction-logs .el-table.services-table th,
#clients-visa-transaction-logs .el-table.services-table td {
  padding: 5px 0px;
}
</style>
