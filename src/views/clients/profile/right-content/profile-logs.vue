<template>
  <div id="clients-visa-profile-logs">
...
export default {
  ...
  methods: {
    ...
    getLogs() {
      ...
      clientProfileLogs({ page: this.page }, this.$route.params.id)
        .then(response => {
...
<style lang="scss">
#clients-visa-profile-logs .el-card__header {
  padding: 10px;
}
</style>
