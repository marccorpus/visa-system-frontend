<template>
  <div id="group-profile-visa-page-payments-expand">
...
<style lang="scss">
#group-profile-visa-page-payments-expand .el-table__footer-wrapper tbody td {
  color: #303133 !important;
  font-weight: bold !important;
}
</style>
<style lang="scss" scoped>
#group-profile-visa-page-payments-expand {
  margin: 15px 0;
