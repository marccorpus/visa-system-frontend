<template>
  <div id="groups-visa-payment-logs">
...
export default {
  ...
  methods: {
    ...
    getLogs() {
      ...
      groupPaymentLogs({ page: this.page }, this.$route.params.id)
        .then(response => {
...
<style lang="scss">
#groups-visa-payment-logs .el-card__header {
  padding: 10px;
}
</style>
