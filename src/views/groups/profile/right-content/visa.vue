<template>
  <div id="group-profile-visa-page">
      ...
      <el-row>
        ...
        <el-col :span="6" :offset="10">
          <el-button
            ...
            class="create-btn"
            @click="
              $router.push({ name: 'GroupCreateTransaction', params: { id } })
            "
            ...
            <template v-if="!scope.row.deleted_at">
              ...
              >
                <i
                  ...
                  @click="toggleRow(scope.row, 'GroupsServicesExpand')"
                ></i>
              </el-tooltip>
              ...
              >
                <i
                  ...
                  @click="toggleRow(scope.row, 'GroupsPaymentsExpand')"
                ></i>
              </el-tooltip>
...
import {
  indexPaginationOfGroup as _transactionsIndexPaginationOfGroup,
...
import GroupsServicesExpand from "./services/index.vue";
import GroupsPaymentsExpand from "./payments/index.vue";
...
export default {
  ...
  methods: {
    getTransactions() {
      ...
      _transactionsIndexPaginationOfGroup(data, this.id)
        .then(response => {
  ...
  components: {
    EditDiscount,
    CancelTransaction,
    GroupsServicesExpand,
    GroupsPaymentsExpand
  },
  created() {
    this.getTransactions();
  }
...
<style lang="scss">
#group-profile-visa-page .el-table.transactions-table th,
#group-profile-visa-page .el-table.transactions-table td {
  padding: 5px 0px;
}
#group-profile-visa-page .el-table.transactions-table .danger-row {
  background: #fef0f0 !important;
  text-decoration: line-through;
}
#group-profile-visa-page
